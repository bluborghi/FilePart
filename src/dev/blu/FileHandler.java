...
public abstract class FileHandler {
    ...
    protected void transfer(FileInputStream fis, FileOutputStream fos, long part_length) throws IOException {
        int MAX_BUF_LENGTH = getBufferLength(); //= 1024*1024*1; //1MiB
        int buffer_length;
